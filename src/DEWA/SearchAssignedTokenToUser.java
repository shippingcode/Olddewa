	  ...
	  String token = GenerateData.generateRandomAlphaNumeric(5);
		...
		public void searchassignedtokentouser()  throws FileNotFoundException {
		  ...
		  //Check the device's status
    		...
    		try{
    		Thread.sleep(1500);
    		driver.findElement(By.name("tab_active")).isDisplayed();
    		}catch(Exception e)
    		{
    		System.out.println(e);
    		  }
