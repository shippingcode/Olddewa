...
package DEWA;
	...
	public class SearchAndRemoveGroup { 
		boolean test=false;
		...
		@Test
		 public void f() throws FileNotFoundException {
		      ...
		      //Create Firefox drive
				...
				//Search the group 
				 WebElement table1 = driver.findElement(By.cssSelector("div.col-md-12 > div.block > div.content"));
				...
				{
					test = true;
					System.out.println("Alert Content Profile was deleted with success");
				}
				else
				{
