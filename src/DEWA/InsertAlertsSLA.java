...
public class InsertAlertsSLA {
  ...
  WebDriver driver = null;
	boolean test = false;
	String[] name = new String[]{"SLA1","SLA2","SLA3","SLA4","SLA5","SLA6","SLA7","SLA8",
 			"SLA9","SLA10","SLA11","SLA12","SLA13","SLA14","SLA15","SLA16","SLA17",
 			"SLA18","SLA19","SLA20","SLA21"};
	String[] event = new String[]{"AlertContent1","AlertContent2","AlertContent3","AlertContent4","AlertContent5","AlertContent6","AlertContent7","AlertContent8",
	...
	String[] alertcontent = new String[] {"AlertContent1","AlertContent2","AlertContent3","AlertContent4","AlertContent5","AlertContent6","AlertContent7","AlertContent8",
 			"AlertContent9","AlertContent10","AlertContent11","AlertContent12","AlertContent13","AlertContent14","AlertContent15","AlertContent16","AlertContent17",
 			"AlertContent18","AlertContent19","AlertContent20","AlertContent21"};
@Test
