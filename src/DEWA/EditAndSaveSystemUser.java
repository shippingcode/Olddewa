...
public class EditAndSaveSystemUser{
	boolean test=false;
	...
	@Test
	 public void searchsystemuserwithactions() throws FileNotFoundException {
		...
		//Change the role into Manager
		WebElement userdropdown1 = driver.findElement(By.name("userLevel"));
		Select user1 = new Select(userdropdown1);
		user1.selectByVisibleText("Manager");
		try{
		Thread.sleep(1500);
		driver.findElement(By.id("save_assignment")).click();
		}catch(Exception e)
