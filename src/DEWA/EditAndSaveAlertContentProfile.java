/* Edit and Save Alert Content Profile by Sms Text Alert filling wildcards */
...
public class EditAndSaveAlertContentProfile {
       boolean test = false;
...
@Test
	public void searchandremoveAlertConetentProfile() throws FileNotFoundException {
			//Login
  ...
  {
	  test = true;
	  System.out.println("ALert Content Profile was edited and saved with success");
  }
  else
  {
