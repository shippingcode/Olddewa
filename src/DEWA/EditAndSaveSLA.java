/* Create, edit and save SLA by changing event priority into Intermediate */
package DEWA;
...
public class EditAndSaveSLA {
		WebDriver driver = null;
		boolean test = false;
  @Test
  public void editandsaveSLA() throws FileNotFoundException {
	  //Login
  ...
  driver.get(prop.getProperty("url1"));
   ...
   try{
		...
		{
			test=true;
			System.out.println("SLA was edited and saved with success");
		}
		else
		{
