/* Add motorist & renew membership type*/
...
package DEWA;
	...
	public class RenewMotoristUser { 
		boolean test=false;
		...
		@Test
		 public void renewuseMotorist() throws FileNotFoundException {
			//Login
		      ...
		      //Create Firefox drive
	    		...
	    		try{
	    		Thread.sleep(1500);
	    		driver.findElement(By.cssSelector("span.icon-credit-card")).click();
	    		}catch(Exception e)
				{
				System.out.println(e);
				}
	    		try{
				Thread.sleep(1500);
	    		driver.findElement(By.id("renewalDate")).click();
	    		for(int i = 1;i<5;i++){
	    		...
	    		try{
				Thread.sleep(1500);
				WebElement memdropdown = driver.findElement(By.name("membershipTypes"));
				Select mem = new Select(memdropdown);
				mem.selectByVisibleText("20-year");
				}catch(Exception e)
				{
				System.out.println(e);
				}
				try{
				Thread.sleep(1500);
	    		driver.findElement(By.id("btnSaveRenew")).click();
	    		}catch(Exception e)
				{
				System.out.println(e);
				}
