...
package DEWA;
	...
	public class InsertMotorist { 
		boolean test=false;
		String[] motorist = {GenerateData.generateRandomString(5), GenerateData.generateRandomString(5), GenerateData.generateRandomString(5), GenerateData.generateRandomString(5), GenerateData.generateRandomString(5)};
		...
		@Test
		 public void createmotorist() throws FileNotFoundException {
		      ...
		      //Create Firefox drive
				...
				try{
				Thread.sleep(1500);
				driver.findElement(By.name("userName")).sendKeys(motorist[i]);
				}catch(Exception e)
				{
				System.out.println(e);
				}
