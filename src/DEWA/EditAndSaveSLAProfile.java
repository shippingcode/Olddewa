/* Create, edit and save SLA Profile by changing Resolution time into 200 */
package DEWA;
...
public class EditAndSaveSLAProfile {
...
@Test
public void editandsaveSLAProfile() throws FileNotFoundException {
	//Login
...
System.out.println(e);
	...
	{
		test=true;
		System.out.println("SLA was updated with success");
	}
	else
	{
